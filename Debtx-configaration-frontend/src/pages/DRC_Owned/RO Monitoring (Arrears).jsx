/*Purpose: This template is used for the 2.4.1- RO Monitoring (Arrears)
...
Notes: The following page conatins the code for the RO Monitoring (Arrears)  */

import { useState } from "react";
import GlobalStyle from "../../assets/prototype/GlobalStyle.jsx"; // Importing GlobalStyle
import { useNavigate } from "react-router-dom";

export default function RO_Monitoring() {
    {/* Data for the table */}
    const data = [
        {
            date:"2025.01.01",
    ...
    const handleTabClick = (tab) => { 
        ...
        if (tab === "Customer Negotiation") {
            ...
            navigate("/drc/ro-monitoring-cpe"); 
        }
    };
